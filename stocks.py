...
def stock_purchases():
    ...
    if stock_name == "Amazon":
        available_shares = dollars_invest / amazon
        available_price = 3000
    elif stock_name == "Apple":
        available_shares = dollars_invest / apple
        available_price = 100
    elif stock_name == "Facebook":
        available_shares = dollars_invest / fb
        available_price = 250
    elif stock_name == "Google":
        available_shares = dollars_invest / google
        available_price = 1400
    elif stock_name == "Microsoft":
        available_shares = dollars_invest / msft
        available_price = 200
    else:
        available_shares = 0
    ...
    print(f"{client_name} has ${dollars_invest} to invest and can buy {int(available_shares)} shares of {stock_name} at the current price of ${int(available_price)}.")
